...
var the_setup = ['setup']
var the_room = ['room']
var setup_room = [the_setup, the_room, L .reread (x => Z .Just (x)), L .valueOr (Z .Nothing)]



window .view = S .root (() => (function () {
    var __;
