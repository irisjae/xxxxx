...
var get_ready_view = _ => so ((_=_=>
    ...
    Surplus.S.effect(function (__range) { return Surplus.insert(__range,  !! not (R .length (_students) === 0)
				? (function () {
    var __, __img1;
...
var game_over_view = _ => so ((_=_=>
  (function () {
    ...
    __setting6 = Surplus.createElement("setting", null, __);
    Surplus.setAttribute(__setting6, "x-for", "background-music");
    Surplus.setAttribute(__setting6, "x-be",  _background_music_on ? 'off' : 'on' );
    __setting6_img1 = Surplus.createElement("img", null, __setting6);
    __setting6_img1.src =  _background_music_on ? music_on_img : music_off_img ;
    Surplus.createTextNode(" ", __)
    ...
    Surplus.S.effect(function (__state) { return ( toggle_background_music )(__setting6, __state); });
    return __;
})(),
  where
  , _lookbehind = lookbehind_state () 
