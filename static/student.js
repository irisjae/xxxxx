...
var setup_room_view = _ => so ((_=_=>
    ...
    Surplus.S.effect(function (__current) { return Surplus.content(__room3_label1,  text_asset_view (img .text_room_number_is) , __current); }, '');
...
var setup_student_view = _ => so ((_=_=>
    ...
    Surplus.createTextNode(" ", __)
    Surplus.S.effect(function (__current) { return Surplus.content(__name3_label1,  text_asset_view (img .text_name) , __current); }, '');
...
var get_ready_view = _ => so ((_=_=>
	(function () {
    var __, __div1, __div1_room1, __div1_room1_insert2, __insert2;
    ...
    Surplus.S.effect(function (__range) { return Surplus.insert(__range,  text_asset_view (img .text_waiting_message) ); }, { start: __insert2, end: __insert2 });
    return __;
})(),
	where
