...
var app_students_map_boards_v_pasts_state = belief ([ L .pick ({ boards: app_boards_state, pasts: app_pasts_state }), L .when (I), ({ boards, pasts }) => map_zip (a => b => [a, b]) (boards) (pasts) ]) (app_state)
